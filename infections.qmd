...
## Filter summary to number of infected farms
farms_inf_summary <- infect_config_summary %>%    
  filter(summary == "farms_infected")

## Filter summary to number of infected cattle
...
## Call summarize_infections function
no_low_virulence_summary <- summarize_infections(no_low_virulence)

## Prepare for significance test
...
## Plot Infected Cattle Across Detection Scenarios
